    ...
    async getHighLevelFeatures(mbid: string): Promise<AcousticBrainzHighLevel | null> {
        try {
            ...
            const highlevel: AcousticBrainzHighLevel = {
                ...
                mood_acoustic:
                    data.highlevel?.mood_acoustic || {
                        acoustic: 0,
                        not_acoustic: 0
                    },
                mood_aggressive:
                    data.highlevel?.mood_aggressive || {
                        aggressive: 0,
                        not_aggressive: 0
                    },
                ...
                mood_electronic:
                    data.highlevel?.mood_electronic || {
                        electronic: 0,
                        not_electronic: 0
                    },
                ...
                voice_instrumental:
                    data.highlevel?.voice_instrumental || {
                        instrumental: 0,
                        voice: 0
                    }
            }
        ...
        if (highlevel) {
            ...
            if (highlevel.danceability) {
                const dance_val =
                    ...
                    (highlevel.danceability.danceable +
                        highlevel.danceability.not_danceable ||
                        1)
            ...
            if (highlevel.energy) {
                const energy_val =
                    ...
                    (highlevel.energy.energetic +
                        highlevel.energy.not_energetic || 1)
            ...
            if (highlevel.mood_acoustic) {
                const acoustic_val =
                    ...
                    (highlevel.mood_acoustic.acoustic +
                        highlevel.mood_acoustic.not_acoustic || 1)
                result.acousticness =
                    Math.round(acoustic_val * 100) / 100
            }
            ...
            if (highlevel.voice_instrumental) {
                const instrumental_val =
                    ...
                    (highlevel.voice_instrumental.instrumental +
                        highlevel.voice_instrumental.voice || 1)
                result.instrumentalness =
                    Math.round(instrumental_val * 100) / 100
            }
            ...
            if (highlevel.mood_happy) {
                const valence_val =
                    ...
                    (highlevel.mood_happy.happy +
                        highlevel.mood_happy.not_happy || 1)
