 ...
 */
export async function extractCoverArt(filePath: string, albumId: string): Promise<string | null> {
  try {
 ...
 */
async function extractEmbeddedCover(filePath: string, albumId: string): Promise<string | null> {
  try {
