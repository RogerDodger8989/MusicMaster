...
export function AlbumListItem({
    ...
    return (
        ...
        >
            ...
            {viewFields.year && (
                <div className="hidden sm:flex items-center gap-1.5 w-16 text-xs text-muted-foreground" title="Year">
                    {album.year}
                </div>
            )}

            {viewFields.tracks && (
                <div className="hidden md:flex items-center gap-1.5 w-16 text-xs text-muted-foreground" title="Tracks">
            ...
            {viewFields.duration && (
                <div className="hidden lg:flex items-center gap-1.5 w-20 text-xs text-muted-foreground" title="Duration">
