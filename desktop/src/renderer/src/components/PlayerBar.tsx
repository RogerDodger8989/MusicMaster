    ...
    return (
        <div className="h-24 border-t border-zinc-900 bg-zinc-950/80 backdrop-blur-xl flex items-center justify-between px-6 z-50 relative">
            ...
            <div className="flex items-center gap-4 min-w-0 w-[30%] max-w-[400px]">
                ...
                <div className="flex flex-col min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {currentTrack && (
                            <div className="flex items-center gap-1 px-2 py-0.5 bg-zinc-900/40 rounded-md border border-white/10 text-[11px] font-bold whitespace-nowrap">
                                ...
                                {useSettings.getState().gaplessEnabled && (
                                    <span className="ml-2 text-[9px] font-black text-emerald-500/80 tracking-tighter border border-emerald-500/20 px-1 rounded-sm">
                                        GAPLESS
                                    </span>
                                )}
                            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center min-w-0 px-4">
                ...
                {currentTrack && (
                    <div className="w-full max-w-2xl flex items-center gap-4 group px-4">
                        <span className="text-xs font-bold text-zinc-400 tabular-nums w-12 text-right opacity-80 group-hover:opacity-100 transition-opacity">
