...
export default function ArtistsView({ onArtistClick }: ArtistsViewProps) {
    ...
    const handlePlayAll = () => {
        ...
        const artistTracks = tracks
            ...
            .sort((a, b) => (b.year || 0) - (a.year || 0) || a.album.localeCompare(b.album) || (a.trackNum || 0) - (b.trackNum || 0))
    ...
    const handleShuffleAll = () => {
        ...
        const artistTracks = tracks.filter(t => t.artist === playModalArtist || t.albumArtist === playModalArtist)
    ...
    const handlePlayRated = () => {
        ...
        const artistTracks = tracks
            .filter(t => (t.artist === playModalArtist || t.albumArtist === playModalArtist) && (t.rating > 0 || t.loved))
