...
import { Search, LayoutGrid, List, Settings2, Play, ChevronDown, ChevronUp, Music } from 'lucide-react'
        ...
        >
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="bg-zinc-900 border border-zinc-800 px-3 py-1.5 pl-9 rounded-md text-sm w-48 md:w-56 text-zinc-300 placeholder:text-zinc-600 focus:outline-none focus:ring-1 focus:ring-blue-600 transition-all"
            />
          </div>
          {/* Sort Dropdown */}
